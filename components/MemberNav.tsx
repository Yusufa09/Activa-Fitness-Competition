      ...
      <div className="max-w-3xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-0.5 sm:gap-1 flex-shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-sm font-medium px-2.5 sm:px-3 py-2 rounded-md text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
          >
          ...
          <button
            ...
            title="Sign Out"
            aria-label="Sign Out"
            className="flex items-center gap-1.5 text-sm font-medium px-2.5 sm:px-3 py-2 rounded-md text-slate-500 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors"
          >
